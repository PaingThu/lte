    ...
    build: {
        ...
        rollupOptions: {
            ...
            input: {
                ...
                'admin/english-grammar': resolve(__dirname, 'src/admin/english-grammar/index.html'),
                'admin/english-pattern': resolve(__dirname, 'src/admin/english-pattern/index.html'),
                'admin/english-pattern/detail': resolve(__dirname, 'src/admin/english-pattern/detail/index.html'),
            },
        },
    },
    plugins: [
